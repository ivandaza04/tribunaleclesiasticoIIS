...
from apps.declaracion.views import DetalleList, BuscarView, DeclaracionList
from apps.declaracion.views import DeclaracionCreate, DeclaracionUpdate, DeclaracionDelete
